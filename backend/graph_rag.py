...
_GLOBAL_QUERY_RE = re.compile(
    r"summarize|summary|overview|main theme|big picture|main points|"
    r"entire document|full picture|this paper|this document|document about|what is this about",
    re.IGNORECASE,
)
...
def build_knowledge_graph(
    ...
    for comm_id, entity_keys in enumerate(entity_communities):
        ...
        if not summary.strip() and chunk_ids:
            ...
            summary = f"Concepts: {', '.join(names[:6])}. {preview}..."
